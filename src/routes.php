...
use Alsay\LaravelH5P\Http\Controllers\ContentApiController;
use Alsay\LaravelH5P\Http\Controllers\EditorApiController;
use Alsay\LaravelH5P\Http\Controllers\FilesApiController;
use Alsay\LaravelH5P\Http\Controllers\LibraryApiController;
use Alsay\LaravelH5P\Http\Middleware\H5PLangMiddleware;
use Alsay\LaravelH5P\Http\Middleware\QueryToken;
use Illuminate\Support\Facades\Route;

//Route::group(['middleware' => [H5PLangMiddleware::class], 'prefix' => 'hapi'], function () {
